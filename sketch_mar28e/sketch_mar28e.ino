...
const char* apSSID = "PowerMonitoring";  // Set AP SSID
const char* apPassword = "12345678";          // Set AP password (8+ chars)
...
float pesoPerKWh = 10.0; 
float costInPesos = 0.0;

const char index_html[] PROGMEM = R"rawliteral(
<!DOCTYPE HTML>
<html>
<head>
  <title>CBSUA Electrical Power Monitoring</title>
...
<body>
  <div class="container">
    ...
    <div class="footer"> &copy 2025 CBSUA Electrical | Power Monitoring</div>
  </div>
</body>
</html>
)rawliteral";
...
void setup() {
  ...
  // Set ESP8266 as an Access Point (AP)
